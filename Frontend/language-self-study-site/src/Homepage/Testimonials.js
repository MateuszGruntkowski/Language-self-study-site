        ...
        <div class="testimonials-container">
          <div class="testimonial-card">
            <p class="testimonial-text">
              "Po 3 miesiącach nauki z AngielskiPlus odważyłam się w końcu
          ...
          <div class="testimonial-card">
            <p class="testimonial-text">
              ...
              moim własnym tempie. AngielskiPlus idealnie spełnił moje
              oczekiwania. Wsparcie lektorów online jest nieocenione!"
            </p>
            <div class="testimonial-author">
              <div class="testimonial-avatar"></div>
              <div>
